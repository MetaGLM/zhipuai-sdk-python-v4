...
from zhipuai.core._request_opt import NotGiven, FinalRequestOptions


# Test Initialization and Default Values
def test_initialization():
    params =  FinalRequestOptions.construct(method="GET", url="http://example.com")
...
def test_get_max_retries(max_retries_input, expected):
    params =  FinalRequestOptions.construct(method="GET", url="http://example.com", max_retries=max_retries_input)
...
def test_construct():
    ...
    params = FinalRequestOptions.construct(**input_data)
